...
public class SkinSPUtil {
    ...
    private static final String TAG = SkinSPUtil.class.getSimpleName();
     ...
     */
    private static String mName = "FxpSkin";

    private static SkinSPUtil mInstance = null;

    public static SkinSPUtil getInstance(Context context) {
        if (null == mInstance) {
            synchronized (TAG) {
                if (null == mInstance) {
                    mInstance = new SkinSPUtil(context.getApplicationContext());
                }
            }
        }
        return mInstance;
    ...
    private SkinSPUtil(Context context) {
        mContext = context;
        if (null == mContext) {
